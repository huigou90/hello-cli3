...
# puts "bea-weblogic-server"
# Matches #
matches [

# Url
{ :url => '/console/login/LoginForm.jsp', :text => 'wlsconsole' },
{ :url => '/wls-wsat/CoordinatorPortType', :text => 'CoordinatorPortType?wsdl'},
{ :url => '/uddi/publish.asmx', :text => '<H3>From RFC 2068 <i>Hypertext Transfer Protocol -- HTTP/1.1</i>'},

# Title
{ :text=>'<title>Default BEA WebLogic Server Web Server Index Page</title>' },
{ :text=>'<TITLE>Default BEA WebLogic Server Web Server Index Page</TITLE>' },
{ :text=>'<H3>From RFC 2068 <i>Hypertext Transfer Protocol -- HTTP/1.1</i>'},
